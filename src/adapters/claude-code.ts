...
const GITIGNORE_STUB_GROUPS = [
  ...
  },
  {
    comment: [
      ...
      '# safe-claude-code so bwrap binds over them instead of leaking stubs. These two',
      "# are files, not directories, so they can't be .gitkeep'd; ignore their launch-time stubs.",
    ].join('\n'),
